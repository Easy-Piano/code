 ...
 */
public class MidiMusicTest implements ru.mipt.cs.test.sasha.Test {
    /*
        ...
        for (int[] note : notes) {
            if (note[1] != -1) {
                ...
                try {
                    ...
                    Logger.getLogger(ru.mipt.cs.test.sasha.SashaMain.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
        midiPlayer.close();
